// 5.31—7.3 期末复习计划数据（5.31 原计划保持不动）
...
window.CIRCUIT_PLAN=[
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "高数下网课：模块一前半（向量概念、数量积、向量积、平面/直线方程）。看完整理公式，做2道空间解析几何基础题。",
    "afternoon": "电路网课课时01—02：电路模型、参考方向、KCL/KVL、电阻等效；边看边整理第1—2章公式。",
    "night1": "电路刷题与复盘：参考方向、KCL/KVL、串并联/源变换基础题，整理错题。",
    "night2": "今日回顾：确认高数下公式卡片和电路第1—2章步骤，写明日计划。",
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "线代网课：第一讲行列式。看完整理性质与计算模板，做2道基础题。",
    "afternoon": "电路网课课时03—04：支路电流法、节点法、网孔法；同步整理列方程步骤。",
    "night1": "电路题型训练：节点法/网孔法/含源电路基础题；最后回看行列式易错点。",
    "night2": "今日回顾：列出节点法、网孔法和行列式的关键步骤。",
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "大物网课：第1章质点运动学、运动建模、牛顿定律。看完整理运动学公式，做2题巩固。",
    "afternoon": "电路网课课时05—06：叠加定理、戴维南、诺顿、最大功率传输；整理解题模板。",
    "night1": "电路刷题：戴维南/诺顿典型题，订正电路定理错题；大物只做公式回看。",
    "night2": "今日回顾：检查电路定理模板和大物第1章公式表。",
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "高数下网课：模块一后半（空间位置关系、曲面及其方程）。看完整理曲面与位置关系判断，做2题。",
    "afternoon": "电路网课课时07：含理想运放的电阻电路；补受控源、等效电路题型整理。",
    "night1": "电路练习：受控源、运放虚短虚断、等效电路题；高数只标记错题。",
    "night2": "今日回顾：复盘运放判断条件和空间解析几何公式。",
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "线代网课：逆矩阵和矩阵方程。看完整理逆矩阵条件、矩阵方程步骤，做2题。",
    "afternoon": "电路网课课时08—09：储能元件、换路定律、一阶电路零输入/零状态基础；整理初始值判断。",
    "night1": "电路刷题：电容电感、换路初始值、一阶电路基础题；线代做矩阵方程订正。",
    "night2": "今日回顾：写出换路连续量和逆矩阵解题模板。",
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "大物网课：第2章前半（转动惯量、动量、动量守恒）。看完整理守恒条件，做2题。",
    "afternoon": "电路网课课时10—11：一阶/二阶时域分析收尾 + 向量法/相量法入门；整理复数与阻抗导纳。",
    "night1": "电路练习：一阶电路三要素、相量互化、阻抗导纳基础题；大物只复盘公式。",
    "night2": "今日回顾：核对一阶电路步骤、相量公式和动量守恒条件。",
  ...
  },
  {
    ...
    "priority": "S级",
    "morning": "高数下网课：模块二前半（多元函数基本概念、偏导数、全微分）。看完整理定义与公式，做2题。",
    "afternoon": "电路网课课时12—13：正弦稳态电路分析（一）（二）；整理相量法列方程步骤。",
    "night1": "电路刷题：正弦稳态功率、有效值、相位关系和综合题；高数只做错题标记。",
    "night2": "今日回顾：复盘正弦稳态步骤和偏导/全微分公式。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "S级",
    "morning": "线代网课：齐次/非齐次线性方程组 + 向量线性表示。看完整理判定条件，做2题。",
    "afternoon": "电路混合练习：一阶电路 + 相量法 + 第1—9章错题整理，按题型归档。",
    "night1": "晚上只做练习复盘：电路错题二刷、线性方程组与向量表示题，整理公式卡。",
    "night2": "今日回顾：确认电路混合题错因和线代方程组模板。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "S级",
    "morning": "大物网课：第2章后半（角动量、角动量守恒、功和能）。看完整理守恒定律公式，做2题。",
    "afternoon": "电路第1—9章公式总整理：KCL/KVL、节点/网孔、戴维南、一阶、相量、正弦稳态。",
    "night1": "电路大题步骤模板训练：典型题按模板重做，订正并标出易错点。",
    "night2": "今日回顾：形成电路考前公式清单和大物第2章守恒表。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "S级",
    "morning": "高数下网课：模块二后半（复合/隐函数求导、几何应用、方向导数、极值）。看完整理公式，做2题。",
    "afternoon": "电路阶段测试/综合刷题：按考试节奏完成一组综合题。",
    "night1": "晚上只订正和复盘：订正电路测试、补弱项；高数下只整理错题和公式卡。",
    "night2": "今日回顾：列出电路弱项清单和高数下模块二公式。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "高数下网课：模块三二重积分计算题型1—6。看完整理换序/极坐标等方法，做2题。",
    "afternoon": "高数下短网课：二重积分题型7与应用；线代网课：极大无关组 + 特征值特征向量，整理模板。",
    "night1": "晚上只做题：二重积分计算/应用题 + 极大无关组/特征值题，订正错题。",
    "night2": "今日回顾：复盘二重积分方法和特征值求法。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "高数下网课：模块四三重积分计算与应用。看完整理坐标选择，做2题。",
    "afternoon": "大物网课：第3章刚体定轴转动核心、拓展、习题。看完整理转动定律和能量关系。",
    "night1": "晚上只做练习：三重积分题 + 刚体定轴转动基础题，整理错题。",
    "night2": "今日回顾：核对三重积分坐标法和刚体转动公式。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：高数下 + 大物。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "高数下网课：模块五曲线积分（计算、路径无关条件）。看完整理格林公式/路径无关条件，做2题。",
    "afternoon": "线代网课：相似对角化、正交替换、二次型。整理判定条件和步骤。",
    "night1": "晚上只刷题：曲线积分题 + 相似对角化/正交/二次型题，订正错题。",
    "night2": "今日回顾：复盘曲线积分条件和二次型步骤。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：高数下 + 线代。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "大物网课：第4章狭义相对论核心。看完整理时间膨胀、长度收缩等公式，做2题。",
    "afternoon": "大物短网课：狭义相对论拓展、习题；高数上补漏只轻量浏览极限/导数/积分基础。",
    "night1": "晚上只整理：狭义相对论错题与公式卡；高数上补漏不加新课。",
    "night2": "今日回顾：核对相对论公式和高数上补漏清单。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：大物 + 高数上补漏。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "高数下网课：模块六曲面积分、曲面积分应用、散度旋度。看完整理公式，做2题。",
    "afternoon": "线代网课：基、维数、坐标 + 小知识集锦行列式。整理概念和易错点。",
    "night1": "晚上只做题：曲面积分题 + 基/维数/坐标/行列式小题，订正错题。",
    "night2": "今日回顾：复盘曲面积分方向判断和线代概念。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：高数下 + 线代。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "高数下网课：模块七级数概念、正项级数、幂级数。看完整理判敛方法，做2题。",
    "afternoon": "大物网课：第5章气体动理论 + 第6章热力学基础。整理热学公式和典型题。",
    "night1": "晚上只做练习：级数判敛题 + 热学基础题，整理错题；傅里叶级数只标记后续补看。",
    "night2": "今日回顾：复盘级数判敛表和热学公式。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：大物 + 高数下。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "线代网课：小知识集锦矩阵、向量组、线性方程组。看完整理知识清单，做对应小题。",
    "afternoon": "线代网课：特征值、相似、正交、二次型小知识；整理考前模板。",
    "night1": "晚上只复盘：大物第1—6章框架回顾，整理公式表；不再加新网课。",
    "night2": "今日回顾：确认线代小知识清单和大物第1—6章公式表。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：线代 + 大物。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "大物网课：第7章静止电荷的电场。看完整理电场强度、高斯定理、电势、电容等公式。",
    "afternoon": "大物网课：第8章恒定电流的磁场。整理安培环路、安培力、磁通量、电动势公式。",
    "night1": "晚上只做练习复盘：大物第7—8章基础题；高数下薄弱模块任选一块轻量回看。",
    "night2": "今日回顾：形成电磁学公式清单。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：大物 + 高数。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "大物试卷1：按考试节奏完成，不安排新网课。",
    "afternoon": "订正试卷，整理大物公式和错题。",
    "night1": "线代公式复盘：行列式、矩阵、方程组模板；只做轻量题。",
    "night2": "今日回顾：记录大物试卷错因和线代模板。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：大物 + 线代。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "大物试卷2：按考试节奏完成，不安排新网课。",
    "afternoon": "订正试卷，整理错题和公式。",
    "night1": "高数错题复盘：积分、级数、空间解析几何；只看旧错题不加新网课。",
    "night2": "今日回顾：确定大物最后回看清单和高数弱项。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：大物 + 高数。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "线代试卷1：按考试节奏完成，不安排新网课。",
    "afternoon": "订正试卷，整理线代错题模板。",
    "night1": "大物考前公式清单：第1、2、5、6、7、8章，只看公式和错题。",
    "night2": "今日回顾：列出线代试卷错因和大物考前重点。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：线代 + 大物。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "A 级",
    "morning": "线代试卷2：按考试节奏完成，不安排新网课。",
    "afternoon": "订正试卷，补线代薄弱题型。",
    "night1": "大物最后回看：公式、错题、典型题步骤；不加新知识。",
    "night2": "今日回顾：确认大物考试前最后清单。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：线代 + 大物。",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "S级",
    "morning": "高数试卷1：按考试节奏完成，不安排新网课。",
    "afternoon": "订正试卷，整理高数错题。",
    "night1": "线代考前公式、错题模板；只做轻量复盘，不加新课。",
    "night2": "今日回顾：确认线代考试前最后清单。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "两门主科：高数 + 线代。",
  ...
  },
  {
    ...
    "priority": "考试",
    "morning": "大学物理考试。",
    "afternoon": "休息 + 线代公式复盘；不安排新网课。",
    "night1": "线性代数考试。",
    "night2": "考试结束后休息，不整理错题、不安排新知识。",
    "review": "考试日只做状态恢复和明日高数安排确认。",
    "task": "考试日：上午大物，晚上线代，不安排其他重任务。",
    "practice": "只参加大学物理考试和线性代数考试，不安排其他重任务。",
    "adjust": "不要安排其他重任务。",
    "checks": [
      "大学物理考试完成",
      "线代公式复盘完成",
  ...
  },
  {
    ...
    "lessonNos": [],
    "priority": "S级",
    "morning": "高数试卷2：按考试节奏完成，不安排新网课。",
    "afternoon": "订正试卷，整理高数最后错题。",
    "night1": "高数错题、公式、常见题型步骤；不安排其他科目。",
    "night2": "今日回顾：只确认明天考试用品和最后公式清单。",
    "review": "复盘当天两门主科的公式、错题和步骤模板。",
    "task": "高数冲刺，不安排其他科目。",
